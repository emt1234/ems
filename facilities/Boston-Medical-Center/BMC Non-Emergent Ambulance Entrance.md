...
## Access
> [!WARNING]
> **Requires a [BMC Badge](./BMC%20EMS%20Badge.md).

## Directions
> [!WARNING]
> You **MUST** have a [BMC Badge](./BMC%20EMS%20Badge.md) to use this entrance. Otherwise, use the [BMC ER Entrance](./BMC%20ER%20Entrance.md) across the street.
> 
...
3. Walk to the two badge-readers on the far wall. Use your [BMC Badge](./BMC%20EMS%20Badge.md) on the **right** badge reader to open the second door.
...
5. Call the elevator.
6. Once elevator arrives, enter and use your [BMC Badge](./BMC%20EMS%20Badge.md) on the inside card-reader, then press "3".
7. Proceed across the skybridge to the main building ([BMC Menino Building](./BMC-Menino-Building/index.md)).
