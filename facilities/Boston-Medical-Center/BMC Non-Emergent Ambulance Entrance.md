...
## Directions
> [!WARNING]
> You **MUST** have a [[./BMC EMS Badge|BMC Badge]] to use this entrance. Otherwise, use the [[./BMC ER Entrance|BMC ER Entrance]] across the street.
> 
...
3. Walk to the two badge-readers on the far wall. Use your [[./BMC EMS Badge|BMC Badge]] on the **right** badge reader to open the second door.
...
5. Call the elevator.
6. Once elevator arrives, enter and use your [[./BMC EMS Badge|BMC Badge]] on the inside card-reader, then press "3".
7. Proceed across the skybridge to the main building ([[./BMC-Menino-Building/index|BMC Menino Building]]).
