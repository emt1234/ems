...
## Access
> [!WARNING]
> **Requires a [BMC Badge](./BMC-EMS-Badge.md).

## Directions
> [!WARNING]
> You **MUST** have a [BMC Badge](./BMC-EMS-Badge.md) to use this entrance. Otherwise, use the [BMC ER Entrance](./BMC-ER-Entrance.md) across the street.
> 
...
3. Walk to the two badge-readers on the far wall. Use your [BMC Badge](./BMC-EMS-Badge.md) on the **right** badge reader to open the second door.
...
5. Call the elevator.
6. Once elevator arrives, enter and use your [BMC Badge](./BMC-EMS-Badge.md) on the inside card-reader, then press "3".
